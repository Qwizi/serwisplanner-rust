//! Auto-generated module for `AccountCompanyAttribute`.
//!
...
/// Resource accessor for `/api/account_company_attributes`.
pub struct AccountCompanyAttributeResource {
    resource: Resource,
}

impl AccountCompanyAttributeResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/account_company_attributes"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<AccountCompanyAttributeListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<AccountCompanyAttribute>> {
