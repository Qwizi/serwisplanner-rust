//! Auto-generated module for `Message`.
//!
...
pub struct Message {
    ...
    pub sender_account_user: Option<AccountUserRel>,
    pub sender_name: Option<String>,
    pub sender_user: Option<UserUserRel>,
    pub thread: Option<MessageThreadRel>,
}
...
/// Resource accessor for `/api/messages`.
...
impl MessageResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/messages"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<MessageListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<Message> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<Message> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Message> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Message> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Message>> {
