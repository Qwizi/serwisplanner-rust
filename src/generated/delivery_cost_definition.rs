//! Auto-generated module for `DeliveryCostDefinition`.
//!
...
/// Resource accessor for `/api/delivery_cost_definitions`.
pub struct DeliveryCostDefinitionResource {
    resource: Resource,
}

impl DeliveryCostDefinitionResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/delivery_cost_definitions"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<DeliveryCostDefinitionListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<DeliveryCostDefinition>> {
