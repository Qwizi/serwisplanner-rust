//! Auto-generated module for `DocumentAttribute`.
//!
...
/// Resource accessor for `/api/document_attributes`.
pub struct DocumentAttributeResource {
    resource: Resource,
}

impl DocumentAttributeResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/document_attributes"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<DocumentAttributeListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<DocumentAttribute>> {
