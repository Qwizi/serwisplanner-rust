//! Auto-generated module for `ImapFolder`.
//!
...
pub struct ImapFolder {
    ...
    pub id: Option<i64>,
    pub last_imap_id: Option<i64>,
    pub last_sync_date: Option<String>,
    pub name: Option<String>,
    pub original_delimiter: Option<String>,
    pub original_full_name: Option<String>,
    pub parent: Option<ImapFolderRel>,
}
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct ImapFolderListResponse {
    pub data: Vec<ImapFolder>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/imap_folders`.
pub struct ImapFolderResource {
    resource: Resource,
}

impl ImapFolderResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/imap_folders"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<ImapFolderListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<ImapFolder> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<ImapFolder> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<ImapFolder> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<ImapFolder> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<ImapFolder>> {
