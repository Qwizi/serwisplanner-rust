//! Auto-generated module for `UserUserAbsenceLimit`.
//!
...
/// Resource accessor for `/api/user_user_absence_limits`.
pub struct UserUserAbsenceLimitResource {
    resource: Resource,
}

impl UserUserAbsenceLimitResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/user_user_absence_limits"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<UserUserAbsenceLimitListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<UserUserAbsenceLimit>> {
