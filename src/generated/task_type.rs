//! Auto-generated module for `TaskType`.
//!
...
/// Resource accessor for `/api/task_types`.
pub struct TaskTypeResource {
    resource: Resource,
}

impl TaskTypeResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/task_types"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<TaskTypeListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<TaskType>> {
