//! Auto-generated module for `Exchange`.
//!
...
/// Resource accessor for `/api/exchanges`.
...
impl ExchangeResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/exchanges"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<ExchangeListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<Exchange> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<Exchange> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Exchange> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Exchange> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Exchange>> {
