//! Auto-generated module for `FavoritePosition`.
//!
...
pub struct FavoritePosition {
    ...
    pub favorite: Option<FavoriteRel>,
    pub id: Option<i64>,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct FavoritePositionListResponse {
    pub data: Vec<FavoritePosition>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/favorite_positions`.
pub struct FavoritePositionResource {
    resource: Resource,
}

impl FavoritePositionResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/favorite_positions"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<FavoritePositionListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<FavoritePosition> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<FavoritePosition> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<FavoritePosition> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<FavoritePosition> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<FavoritePosition>> {
