//! Auto-generated module for `UserUserAttribute`.
//!
...
/// Resource accessor for `/api/user_user_attributes`.
pub struct UserUserAttributeResource {
    resource: Resource,
}

impl UserUserAttributeResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/user_user_attributes"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<UserUserAttributeListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<UserUserAttribute>> {
