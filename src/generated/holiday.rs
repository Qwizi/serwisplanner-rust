...
/// Resource accessor for `/api/holidaies`.
pub struct HolidayResource {
    resource: Resource,
}

impl HolidayResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/holidaies"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<HolidayListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<Holiday> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<Holiday> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Holiday> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Holiday> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Holiday>> {
