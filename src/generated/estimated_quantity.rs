...
/// Resource accessor for `/api/estimated_quantities`.
pub struct EstimatedQuantityResource {
    resource: Resource,
}

impl EstimatedQuantityResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/estimated_quantities"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<EstimatedQuantityListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<EstimatedQuantity> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<EstimatedQuantity> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<EstimatedQuantity> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<EstimatedQuantity> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<EstimatedQuantity>> {
