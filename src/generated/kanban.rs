//! Auto-generated module for `Kanban`.
//!
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct KanbanListResponse {
    pub data: Vec<Kanban>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/kanbans`.
pub struct KanbanResource {
    resource: Resource,
}
...
impl KanbanResource {
    ...
    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<KanbanListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<Kanban> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<Kanban> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Kanban> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Kanban> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Kanban>> {
