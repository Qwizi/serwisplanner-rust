//! Auto-generated module for `EmailTemplate`.
//!
...
/// Resource accessor for `/api/email_templates`.
pub struct EmailTemplateResource {
    resource: Resource,
}

impl EmailTemplateResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/email_templates"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<EmailTemplateListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<EmailTemplate> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<EmailTemplate> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<EmailTemplate> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<EmailTemplate> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<EmailTemplate>> {
