//! Auto-generated module for `ServicedProductHistory`.
//!
...
pub struct ServicedProductHistory {
    pub account_user: Option<AccountUserRel>,
    pub attribute: Option<ServicedProductAttributeRel>,
    ...
    pub serviced_product: Option<ServicedProductRel>,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default, rename_all = "camelCase")]
pub struct ServicedProductAttributeRel {
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct ServicedProductHistoryListResponse {
    pub data: Vec<ServicedProductHistory>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/serviced_product_histories`.
pub struct ServicedProductHistoryResource {
    resource: Resource,
}

impl ServicedProductHistoryResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/serviced_product_histories"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<ServicedProductHistoryListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<ServicedProductHistory> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<ServicedProductHistory> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<ServicedProductHistory> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<ServicedProductHistory> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<ServicedProductHistory>> {
