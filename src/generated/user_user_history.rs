...
pub struct UserUserHistory {
    pub edited_user_user: Option<UserUserRel>,
...
/// Resource accessor for `/api/user_user_histories`.
pub struct UserUserHistoryResource {
    resource: Resource,
}

impl UserUserHistoryResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/user_user_histories"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<UserUserHistoryListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<UserUserHistory> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<UserUserHistory> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<UserUserHistory> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<UserUserHistory> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<UserUserHistory>> {
