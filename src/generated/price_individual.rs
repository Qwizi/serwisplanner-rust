//! Auto-generated module for `PriceIndividual`.
//!
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct PriceIndividualListResponse {
    pub data: Vec<PriceIndividual>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/price_individuals`.
pub struct PriceIndividualResource {
    resource: Resource,
}

impl PriceIndividualResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/price_individuals"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<PriceIndividualListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<PriceIndividual> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<PriceIndividual> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<PriceIndividual> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<PriceIndividual> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<PriceIndividual>> {
