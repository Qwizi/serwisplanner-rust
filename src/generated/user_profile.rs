//! Auto-generated module for `UserProfile`.
//!
...
/// Resource accessor for `/api/user_profiles`.
...
impl UserProfileResource {
    ...
    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<UserProfileListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<UserProfile>> {
