//! Auto-generated module for `CommissionAttributeRelations`.
//!
...
pub struct CommissionAttributeRelations {
    pub attribute: Option<CommissionAttributeRel>,
    pub id: Option<i64>,
    pub name: Option<String>,
    pub priority: Option<i64>,
    pub product_template: Option<ProductTemplateRel>,
}
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct CommissionAttributeRelationsListResponse {
    pub data: Vec<CommissionAttributeRelations>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/commission_attribute_relations`.
pub struct CommissionAttributeRelationsResource {
    resource: Resource,
}

impl CommissionAttributeRelationsResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/commission_attribute_relations"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<CommissionAttributeRelationsListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<CommissionAttributeRelations> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<CommissionAttributeRelations> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<CommissionAttributeRelations> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<CommissionAttributeRelations> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<CommissionAttributeRelations>> {
