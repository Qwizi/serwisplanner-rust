//! Auto-generated module for `ProfileSetting`.
//!
...
/// Resource accessor for `/api/profile_settings`.
pub struct ProfileSettingResource {
    resource: Resource,
}

impl ProfileSettingResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/profile_settings"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<ProfileSettingListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<ProfileSetting>> {
