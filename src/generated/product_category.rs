...
pub struct ProductCategory {
    pub i18ns: Option<ProductCategoryI18nRel>,
    pub id: Option<i64>,
    ...
    pub parent: Option<ProductCategoryRel>,
}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default, rename_all = "camelCase")]
pub struct ProductCategoryI18nRel {
    pub id: Option<i64>,
    pub import_code: Option<String>,
    pub import_id: Option<i64>,
    pub import_typ: Option<String>,
...
/// Resource accessor for `/api/product_categories`.
pub struct ProductCategoryResource {
    resource: Resource,
}

impl ProductCategoryResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/product_categories"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<ProductCategoryListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<ProductCategory> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<ProductCategory> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<ProductCategory> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<ProductCategory> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<ProductCategory>> {
