//! Auto-generated module for `EmailMessage`.
//!
...
pub struct EmailMessageListResponse {
    pub data: Vec<EmailMessage>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/email_messages`.
pub struct EmailMessageResource {
    resource: Resource,
}

impl EmailMessageResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/email_messages"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<EmailMessageListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<EmailMessage> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<EmailMessage> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<EmailMessage> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<EmailMessage> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<EmailMessage>> {
