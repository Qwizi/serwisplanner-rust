//! Auto-generated module for `Basket`.
//!
...
/// Resource accessor for `/api/baskets`.
pub struct BasketResource {
    resource: Resource,
}
...
impl BasketResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/baskets"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<BasketListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Basket>> {
