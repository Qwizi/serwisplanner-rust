//! Auto-generated module for `MessageThreadUser`.
//!
...
pub struct MessageThreadUser {
    pub account_user: Option<AccountUserRel>,
    pub date_added: Option<String>,
    pub id: Option<i64>,
    pub is_active: Option<bool>,
    pub last_read_message: Option<MessageRel>,
    pub message_thread: Option<MessageThreadRel>,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct MessageThreadUserListResponse {
    pub data: Vec<MessageThreadUser>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/message_thread_users`.
pub struct MessageThreadUserResource {
    resource: Resource,
}

impl MessageThreadUserResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/message_thread_users"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<MessageThreadUserListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<MessageThreadUser> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<MessageThreadUser> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<MessageThreadUser> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<MessageThreadUser> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<MessageThreadUser>> {
