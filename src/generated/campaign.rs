//! Auto-generated module for `Campaign`.
//!
...
/// Resource accessor for `/api/campaigns`.
...
impl CampaignResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/campaigns"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<CampaignListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Campaign>> {
