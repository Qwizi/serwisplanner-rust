//! Auto-generated module for `CommissionPhase`.
//!
...
/// Resource accessor for `/api/commission_phases`.
pub struct CommissionPhaseResource {
    resource: Resource,
}

impl CommissionPhaseResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/commission_phases"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<CommissionPhaseListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<CommissionPhase>> {
