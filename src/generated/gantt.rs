//! Auto-generated module for `Gantt`.
//!
...
pub struct Gantt {
    ...
    pub filter_additional_user_users: Option<String>,
    pub filter_projects: Option<String>,
    pub filter_responsible_user_users: Option<String>,
    pub filter_user_profiles: Option<String>,
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(default)]
pub struct GanttListResponse {
    pub data: Vec<Gantt>,
    pub meta: Option<super::ListMeta>,
}

/// Resource accessor for `/api/gantts`.
...
impl GanttResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/gantts"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<GanttListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<Gantt> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<Gantt> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Gantt> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Gantt> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Gantt>> {
