...
pub struct Target {
    ...
    pub creator_user: serde_json::Value,
    pub editor_user: serde_json::Value,
    pub end_date: String,
    pub id: i64,
    pub interval: String,
    pub min_req_creds: i64,
    pub name: String,
    pub target_delegates: serde_json::Value,
    pub target_objectives: serde_json::Value,
}
