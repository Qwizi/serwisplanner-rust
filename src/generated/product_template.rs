//! Auto-generated module for `ProductTemplate`.
//!
...
/// Resource accessor for `/api/product_templates`.
...
impl ProductTemplateResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/product_templates"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<ProductTemplateListResponse> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<ProductTemplate>> {
