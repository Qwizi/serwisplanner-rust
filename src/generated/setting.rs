//! Auto-generated module for `Setting`.
//!
...
/// Resource accessor for `/api/settings`.
pub struct SettingResource {
    resource: Resource,
}

impl SettingResource {
    pub(crate) fn new(inner: Arc<ClientInner>) -> Self {
        Self {
            resource: Resource::new(inner, "/api/settings"),
        }
    }

    /// List resources.
    pub async fn list(&self, params: Option<&QueryParams>) -> Result<SettingListResponse> {
        let value = self.resource.list(params).await?;
        serde_json::from_value(value).map_err(|e| crate::error::SWError::Other(e.to_string()))
    }

    /// Retrieve a single resource by ID.
    pub async fn retrieve(&self, id: u64, params: Option<&QueryParams>) -> Result<Setting> {
    ...
    pub async fn create(&self, data: &Value, params: Option<&QueryParams>) -> Result<Setting> {
    ...
    /// Update a resource.
    pub async fn update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Setting> {
    ...
    pub async fn partial_update(&self, id: u64, data: &Value, params: Option<&QueryParams>) -> Result<Setting> {
    ...
    pub async fn all(&self, params: Option<QueryParams>) -> Result<Vec<Setting>> {
